                ...
                <nav class="in-navigation">
                    ...
                    ?>
                        <ul>
                            ...
                            ?>
                                <li class="<?php echo ($navigation['level1'] == '') ? '' : 'in-dropdown'; ?> wl-in-dropdown"><a href="<?php echo (($navigation['flag'] == 1) ? base_url() . $navigation['link'] : 'javascript:void(0)'); ?>"><?php echo $navigation['menu']; ?></a>
                                    <?php
